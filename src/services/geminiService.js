...
// ... Schemas (truncated for memory, will be included in full write)
// I will write the schemas here manually from the previous view_file calls.
...
export const getPhrasalVerbOfTheDay = async () => {
    try {
        const response = await ai.models.generateContent({
...
export const getAffixOfTheDay = async () => {
    try {
        const response = await ai.models.generateContent({
...
export const generateTutorResponse = async (prompt) => {
    try {
        const response = await ai.models.generateContent({
            contents: prompt
        });
...
export const createSpeakingSimulatorSession = (scenario) => {
    return ai.chats.create({
        config: {
...
export const createCreativeWritingSession = (format, start) => {
    return ai.chats.create({
        config: {
...
export const getTurkishToEnglishTranslation = async (word) => {
    try {
        const response = await ai.models.generateContent({
...
export const getEli5Explanation = async (word, entry) => {
    const context = `
        Word: ${word}
...
export const generateSimilarQuiz = async (analysis, originalQuestion) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeReadingPassage = async (passage) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeWrittenText = async (topic, text) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeVisualDescription = async (text) => {
    try {
        const response = await ai.models.generateContent({
...
export const improveParagraph = async (paragraph) => {
    try {
        const response = await ai.models.generateContent({
...
export const generateListeningTask = async (difficulty) => {
    try {
        const response = await ai.models.generateContent({
...
export const deconstructPassage = async (passage) => {
    try {
        const response = await ai.models.generateContent({
...
export const getNewsSummary = async (topic) => {
    try {
        ...
        // Simplified for vanilla JS - OpenAI adapter result handling
        return {
            text: response.text,
            sources: [] // Grounding data handling might differ, simplified for now
        };
...
export const generateNewsQuestions = async (paragraph) => {
    try {
        const response = await ai.models.generateContent({
...
export const diagramSentence = async (sentence) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeParagraphCohesion = async (paragraph) => {
    try {
        const response = await ai.models.generateContent({
...
export const generateStudyPlan = async (performanceStats, targetDate, weeklyHours, cefrReport) => {
    try {
...
export const extractExamFromPDF = async (file) => {
    const filePart = {
        inlineData: {
            mimeType: file.type,
...
export const generateSentenceOrderingExercise = async (difficulty) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeConversationForReport = async (scenario, conversation) => {
...
export const deconstructPhrasalVerb = async (phrasalVerb) => {
    try {
        const response = await ai.models.generateContent({
...
export const generateVocabularyStory = async (words) => {
...
export const analyzeAndTranslateSentence = async (sentence, direction) => {
    try {
        const response = await ai.models.generateContent({
...
export const generateDialogueExercise = async (difficulty) => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzePragmatics = async (text) => {
    try {
        const response = await ai.models.generateContent({
...
export const identifyObjectsInImage = async (base64Image, mimeType) => {
    const imagePart = {
        inlineData: {
            mimeType,
            data: base64Image,
...
export const generateCrossword = async (words) => {
...
export const generateGrammarGapsStory = async (difficulty) => {
...
export const generateConceptWeaverWords = async () => {
    try {
        const response = await ai.models.generateContent({
...
export const analyzeConceptWeaverStory = async (words, story) => {
    try {
        const response = await ai.models.generateContent({
...
export const getGrammarTopicDetails = async (topic) => {
    try {
        const response = await ai.models.generateContent({
...
export const checkUserGrammarSentence = async (sentence, rule) => {
    try {
        const response = await ai.models.generateContent({
...
export const evaluatePlacementTest = async (testContent, userAnswers) => {
...
export const generateEssayOutline = async (essayType, topic) => {
    try {
        const response = await ai.models.generateContent({
...
export const writeFullEssayFromOutline = async (topic, outline) => {
    try {
        const response = await ai.models.generateContent({
...
export const generatePodcastAudio = async (script, voiceName, rate, pitch) => {
    try {
